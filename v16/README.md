...
docker tag chumaky/postgres_mssql_fdw:16.2_fdw2.0.3     chumaky/postgres_mssql_fdw
docker tag chumaky/postgres_mysql_fdw:16.2_fdw2.9.1     chumaky/postgres_mysql_fdw
docker tag chumaky/postgres_oracle_fdw:16.3_fdw2.6.0    chumaky/postgres_oracle_fdw
docker tag chumaky/postgres_redis_fdw:16.2_fdw16.2.0    chumaky/postgres_redis_fdw
docker tag chumaky/postgres_sqlite_fdw:16.2_fdw2.4.0    chumaky/postgres_sqlite_fdw
```